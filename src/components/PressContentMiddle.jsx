        ...
        <div className='flex md:w-1/2 bg-gray-200 md:h-full flex-col md:flex-col md:gap-6 md:p-16 rounded-xl p-6 gap-3'>
            ...
            <div className='flex flex-col gap-3 '>
                ...
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Competitive pay</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Micro savings pension scheme</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Flexible hours</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>24/7 support</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
        ...
        <div className='flex md:w-1/2 bg-gray-200 md:h-full flex-col md:flex-col md:gap-6 md:p-16 rounded-xl p-6 gap-3'>
            ...
            <div className='flex flex-col gap-3 '>
                ...
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Safe and reliable rides</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Affordable fares</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Convenient booking options</h1>
                    </div>
                </div>
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    <div className='md:w-5 md:h-5 md:pt-1 pt-2'>
