...
export default function RiderTripHistory() {
...
//    }
  ...
  return (
        ...
        <div className='flex flex-col md:w-full w-full px-6 md:py-12'>
            ...
            <div className=' flex flex-col md:flex-col gap-6 md:gap-8  w-full md:min-h-screen'>
                <div className='flex md:flex-row md:justify-between'>

                    <h1 className='font-extrabold text-[#000000] text-[24px] md:text-[36px] roboto'>My Trip History</h1>
