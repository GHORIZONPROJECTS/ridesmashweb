...
const AboutTitle = () => {
  return (
    ...
    <div className="w-full md:w-96 md:items-center md:justify-center items-center justify-center h-full md:h-1/3 mx-5 lg:mx-10">
        <h1 className="text-2xl md:text-gray-300 text-gray-700 md:text-4xl md:font-extrabold roboto">About Us</h1>
        <div className="flex flex-row py-2 items-center">
            ...
            <p className="ml-1 text-base text-gray-400 md:text-white lg:text-2xl">About Us</p>
        </div>
