    ...
    <div className=' flex h-screen items-center md:justify-center md:w-full relative overflow-hidden bg-green-90 bg-cover bg-center bg-no-repeat text-white sm:flex-row sm:gap-12 sm:py-24  xl:max-h-[598px] 2xl:rounded-5xl;'>
        ...
        <div className="z-20 flex w-full flex-1 flex-col items-start justify-center gap-12 md:px-12 absolute md:flex-row-reverse bg-white opacity-90 md:h-full md:justify-between md:items-center h-screen px-3">
            ...
            <div className=" md:w-1/2">
                ...
                <img src={airport} alt='' className=' rounded-3xl'/>
            </div>
            <motion.div
            ...
            className=' md:w-1/2'>
                <h1 className='md:text-4xl text-3xl font-bold text-black md:text-gray-600 mb-5 leading-normal'>Airport Pickup:</h1>
                <p className='text-gray-500 text-lg mb-4'>Pre-book a comfortable and reliable ride to or from the airport through the Ridesmash app. Take the stress out of airport commutes.</p>
                <p className='text-gray-500 text-lg mb-4'>For our users arriving or departing air travelers who want a smooth transition to/from their destination.</p>
                ...
                <div className='flex  md:flex-row gap-2 md:items-center mb-4 items-center '>
                  ...
                  <p className='text-gray-500 text-lg '>Guaranteed pick-up and drop-off at the airport.</p>
               </div>
               <div className='flex  md:flex-row gap-2 md:items-center mb-4 items-center '>
                  <FaSquare size={8} color='gray' />
                  <p className='text-gray-500 text-lg '>Reliable transportation you can count on after a long flight.</p>
               </div>
               <div className='flex  md:flex-row gap-2 md:items-center mb-4 items-center '>
                  <FaSquare size={8} color='gray' />
                  <p className='text-gray-500 text-lg '>Pre-booking ensures a car is waiting upon arrival (avoiding wait times).</p>
               </div>
            </motion.div>
