        ...
        <div className='flex md:w-1/2 bg-gray-200 md:h-full flex-col md:flex-col md:gap-6 md:p-16 rounded-xl p-6 gap-3'>
            ...
            <div className='flex flex-col gap-3 '>
                ...
                <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <h1 className='text-gray-700 text-base md:text-xl'>Accepted vehicles for Ridesmash Lite.</h1>
                    </div>
                </div>
            ...
            <div className='flex flex-col gap-6 '>
                ...
                <div className='flex md:flex-col flex-col'>
                        ...
                        <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                            ...
                            <div className='flex flex-col gap-6'>
                                <h1 className='text-gray-700 text-base md:text-xl'>Accepted vehicles for Ridesmash Classic. </h1>
                            </div>
                        </div>
                        <div className='flex md:flex-col flex-col gap-2 md:ml-12 '>
                ...
                <div className='flex md:flex-col flex-col'>
                        ...
                        <div className='flex  md:flex-row gap-2 md:gap-4 md:items-start mb-4 items-center'>
                            ...
                            <div className='flex flex-col gap-3'>
                                <h1 className='text-gray-700 text-base md:text-xl'>Accepted vehicles for Ridesmash Executive.</h1>
                            </div>
                        </div>
                        <div className='flex md:flex-col flex-col gap-2 md:ml-12 '>
