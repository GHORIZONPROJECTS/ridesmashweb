...
{/*            
            ...
            className=' md:w-full'>
                <h1 className='md:text-4xl text-2xl font-bold text-gray-500 mb-5 leading-normal'>THE ECONOMIC BENEFITS OF E-HAILING AND WHY RIDESMASH IS THE ACCLAIMED PLATFORM FOR SELF – REGULATED WORK SCHEME</h1>

                <p className='text-gray-500 text-lg mb- text-justify'>With all the hype and the news around E-hailing in Africa cities, especially the 2 major countries operation in Nigeria and Ghana, it has become pertinent to  underscore the major benefits of this business to the public and why Ridesmash has become the Industry benchmark for service delivery and productivity vis-à-vis International best practice.</p>

                <p className='text-gray-500 text-lg text-justify'>While the BRT may have dedicated routes and bus stops for its operation, E-hailing mobility system is better in comparison, because although it uses the general road network and bus stops, there is almost always a single rider or at most 2 to 3 related riders who may demand drop-offs before the final destination. Thus, E-hailing system saves productive time.</p>

                <p className='text-gray-500 text-lg text-justify '> In peculiar cases, like what obtains in Nigeria and in some African countries, checkpoints by government establishments like the police, Road Safety Corps and vehicle inspection office are always on the neck of the drivers of commercially operated vehicles. This is not so with E-hailing mobility system, the E-hailing is a framework founded upon stringent terms of operations and must operate within such terms of its license must not be revoked. For this reason, it is less likely that E-hailing Mobility system would face such level of interference from government established agencies.</p>
