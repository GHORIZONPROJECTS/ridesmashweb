            ...
            <div className="flex md:flex-row flex-col justify-between md:items-center gap-10">
                <motion.div 
                  ...
                  className="md:w-3/5 w-full flex flex-col">
                    <h1 className="lg:text-5xl md:text-4xl text-4xl text-white font-bold leading-relaxed ">RIDE IN STYLE,</h1>
                    <h1  className="lg:text-5xl md:text-4xl text-4xl text-white font-bold">RIDE IN COMFORT</h1>
